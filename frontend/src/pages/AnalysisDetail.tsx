...
import type { CsvHotspot, ReportResponse, StoredAnalysis } from '@/types/api'
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex flex-wrap items-center gap-3 text-sm text-slate-500">
          ...
          {analysis.completed_at ? <span>Completed {formatDateTime(analysis.completed_at)}</span> : null}
        </div>
